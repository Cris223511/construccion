...
?>
                ...
                <form name="formulario" id="formulario" method="POST">
                  <div class="form-group col-lg-12 col-md-12 col-sm-12" style="background-color: white; border-top: 3px #3686b4 solid; padding: 20px;">
                    ...
                    <div class="form-group col-lg-6 col-md-6 col-md-12">
                      ...
                      <input type="number" class="form-control" name="cantidad" id="cantidad" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" maxlength="4" onkeydown="evitarNegativo(event)" onpaste="return false;" onDrop="return false;" min="0" placeholder="Ingrese la cantidad." required>
                    </div>
                    <div class="form-group col-lg-6 col-md-6 col-md-12">
                  ...
                  <div class="form-group col-lg-12 col-md-12 col-sm-12" style="background-color: white !important; padding: 20px !important;">
                    <div class="form-group col-lg-6 col-md-6 col-md-12 botonArt">
  ...
  require 'footer.php';
  ?>
  <script type="text/javascript" src="scripts/entradas5.js"></script>
<?php
}
ob_end_flush();
?>