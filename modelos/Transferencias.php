...
class Transferencia
{
	...
	{
		$sql = "SELECT dtr.idtransferencia, dtr.idarticulo, a.nombre AS articulo, c.titulo AS categoria, ma.titulo AS marca, me.titulo AS medida, a.codigo, a.codigo_producto, a.stock, a.stock_minimo, a.imagen, dtr.cantidad
