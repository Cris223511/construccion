...
class PDF_Invoice extends FPDF
{
	...
	function addClientAdresse($cliente, $domicilio, $num_documento, $email, $telefono)
	{
		...
		$this->SetXY($r1, $y1 - 3);
		$this->SetFont("Arial", "B", 10);
		$this->MultiCell(60, 4, "TIPO: PERSONAL");
		$this->SetXY($r1, $y1 + 5);
		$this->SetFont("Arial", "B", 10);
	...
	// Client address
	function addClientAdresse5($cliente)
	{
		$r1     = $this->w - 200;
		$r2     = $r1 + 68;
		$y1     = 40;
		...
		$this->SetXY($r1, $y1 + 5);
		$this->SetFont("Arial", "", 10);
		$this->MultiCell(150, 14, ($cliente == "") ? "" : $cliente);
	}
