    ...
    switch ($_GET["op"]) {
      ...
      case 'listarDetalle':
        ...
        echo '<thead style="background-color:#A9D0F5">
									...
									<th>Marca</th>
									<th>Local</th>
                                    <th>Cantidad Solicitada <a href="#" data-toggle="popover" data-placement="top" title="Cantidad Solicitada" data-content="Es la cantidad que solicitaste prestar al almacenero." style="color: #002a8e"><i class="fa fa-question-circle"></i></a></th>
                                    <th>Cantidad Prestada <a href="#" data-toggle="popover" data-placement="top" title="Cantidad Prestada" data-content="Es la cantidad que te prestó el almacenero." style="color: #002a8e"><i class="fa fa-question-circle"></i></a></th>
        ...
        while ($reg = $rspta->fetch_object()) {
          ...
          echo '<tr class="filas"><td></td><td>' . $reg->nombre . '</td><td>' . $reg->categoria . '</td><td>' . $reg->marca . '</td><td>' . $reg->local . '</td><td>' . $reg->cantidad . '</td><td>' . $reg->cantidad_prestada . '</td><td>' . $reg->cantidad_devuelta . '</td><td>' . $estado . '</td></tr>';
        }
        break;
      ...
      case 'listarDetalle3':
        ...
        echo '<thead style="background-color:#A9D0F5">
									...
									<th>Cantidad Solicitada <a href="#" data-toggle="popover" data-placement="top" title="Cantidad Solicitada" data-content="Es la cantidad que solicitaste prestar al almacenero." style="color: #002a8e"><i class="fa fa-question-circle"></i></a></th>
									<th>Cantidad Prestada <a href="#" data-toggle="popover" data-placement="top" title="Cantidad Prestada" data-content="Es la cantidad que te prestó el almacenero." style="color: #002a8e"><i class="fa fa-question-circle"></i></a></th>
									<th>Cantidad a devolver <a href="#" data-toggle="popover" data-placement="top" title="Cantidad a devolver" data-content="Es la cantidad que el encargado solicitó devolver al almacén." style="color: #002a8e"><i class="fa fa-question-circle"></i></a></th>
									<th>Estado</th>
								</thead>';
