			...
			case 'guardaryeditar':
				if (empty($idproveedor)) {
					...
					if ($nombreExiste) {
						...
						$rspta = $proveedores->agregar($idusuario, $nombre, $tipo_documento, $num_documento, $direccion, $telefono, $email, $fecha_nac);
					...
					if ($nombreExiste) {
						...
						$rspta = $proveedores->editar($idproveedor, $nombre, $tipo_documento, $num_documento, $direccion, $telefono, $email, $fecha_nac);
