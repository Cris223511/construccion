      ...
      case 'listarArticulosSolicitud':
        ...
        while ($reg = $rspta->fetch_object()) {
          ...
          $data[] = array(
            ...
            "16" => '<div class="nowrap-cell">' . (($reg->fecha_emision == '00-00-0000') ? 'Sin registrar.' : $reg->fecha_emision) . '</div>',
            "17" => '<div class="nowrap-cell">' . (($reg->fecha_vencimiento == '00-00-0000') ? 'Sin registrar.' : $reg->fecha_vencimiento) . '</div>',
            ...
            "22" => $reg->usuario,
            "23" => $cargo_detalle,
            "24" => '<div class="nowrap-cell">' . ($reg->fecha) . '</div>',
